...
<head>
    ...
    <!-- jQuery -->
    <script type="text/javascript" src="/lihuaiotweb01/js/deviceUnionORG.js"></script>
    <!-- jQuery ztree -->
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <jsp:include page="deviceUnionOneORG.jsp"></jsp:include>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="addNew-content">
            <form action="" method="post">
                <div class="form-num">
                    ...
                    <input type="text" class="input-sm" disabled="true" name="code" id="code"/>
                </div>
                <div class="form-name">
                    <label for="name">名称</label>
                    <input type="text" class="input-sm" disabled="true" name="name" id="name"/>
                </div>
                <div class="form-org">
                    <div class="row">
...
<script type="text/javascript">
    $("#nav li:nth-child(11)").addClass("active");
    /*第三步：初始化Datatables*/
    $(function () {
        var txtSearch = "";
