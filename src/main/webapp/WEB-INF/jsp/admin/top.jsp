    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                　    <a href="##" class="navbar-brand">立华物联网查看系统</a>
                　</div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="/lihuaiotweb01/admin/passwordRest">
                            ...
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="/lihuaiotweb01/logout">
