...
function selectDeviceByTreeId() {
    ...
    $('#table_id_example').bootstrapTable({
        ...
        url: "/lihuaiotweb01/deviceUnionORG/selectDeviceByORGId",
...
function initTable() {
    ...
    $.ajax({
        type: 'POST',
        data: {},
        url: '/lihuaiotweb01/deviceUnionORG/DeviceHead',
        dataType: "json",
        success: function (result) {
            /*alert("1");*/
            var json = eval(result); //数组
...
function changeUnionORG(id,orgid) {
    $.ajax({
        type: 'POST',
        data: {deviceId:id,orgId:orgid},
        url: '/lihuaiotweb01/deviceUnionORG/changeUnionORG',
        dataType: "text",
        success: function (result) {
            /*alert("1");*/
            //alert(result);
...
function initTest() {
    $("#org").bsSuggest('init', {
        ...
        clearable: true,
        url: "/lihuaiotweb01/deviceUnionORG/selectZTreeNode",
        idField: "id",
        keyField: "name",
